package com.momao.common.mybatis.handler;
...
import com.momao.common.mybatis.annotation.DataColumn;
import com.momao.common.mybatis.annotation.DataPermission;
import com.momao.common.mybatis.enums.DataScopeType;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/sycy/issues/IB4CS4
